<script lang="ts">
    ...
    const uploadAvatar = (event: any) => {
        ...
        reader.onload = () => {
            if (typeof reader.result?.toString() !== 'string') return;

            avatarRef.src = reader.result.toString();
        }
...
<div>
    ...
    <div class="grid grid-cols-[3fr_1fr] gap-16">
        <div>
            ...
            <div class="mb-16">
                <h2 class="text-neutral-200 font-bold text-2xl mb-4">Mot de passe</h2>
                <form>
                    <div class="bg-neutral-800 rounded-md border border-neutral-600 p-6 grid grid-cols-2 gap-6">
                        <TextInput label="Ancien mot de passe" name="oldPassword" type="password" />
                        <TextInput label="Nouveau mot de passe" name="newPassword" type="password" />
                    </div>
    
                    <div class="flex justify-end mt-3">
                        <Button variant="contained">Modifier le mot de passe</Button>
                    </div>
                </form>
            </div>
        ...
        <div>
            <div>
                <h3 class="text-neutral-300 font-semibold text-md mb-3">Lier mes réseaux sociaux</h3>
                <div>
                    <div class="bg-white flex items-center p-2 rounded-md cursor-pointer mb-3 border-2 border-neutral-300">
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="71" height="55" viewBox="0 0 71 55" fill="none" class="w-6 h-6">
                            ...
                            <p class="text-black ml-3 font-medium text-sm">Dissocier mon compte Discord</p>
                        </div>
                    </div>
                    <div class="bg-white flex items-center p-2 rounded-md cursor-pointer mb-3 border-2 border-neutral-300">
                        <div class="flex items-center">
                            ...
                            <p class="text-black ml-3 font-medium text-sm">Lier mon compte Github</p>
                        </div>
                    </div>
                    <div class="bg-white flex items-center p-2 rounded-md cursor-pointer mb-3 border-2 border-neutral-300">
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 305 305" style="enable-background:new 0 0 305 305;" xml:space="preserve" class="w-6 h-6">
                                <g>
                                    ...
                                    <path id="XMLID_230_" d="M212.101,0.002c-15.763,0.642-34.672,10.345-45.974,23.583c-9.605,11.127-18.988,29.679-16.516,48.379   c0.155,1.17,1.107,2.073,2.284,2.164c1.064,0.083,2.15,0.125,3.232,0.126c15.413,0,32.04-8.527,43.395-22.257   c11.951-14.498,17.994-33.104,16.166-49.77C214.544,0.921,213.395-0.049,212.101,0.002z"/>
                                </g>
                            </svg>
                            <p class="text-black ml-3 font-medium text-sm">Lier mon compte Apple</p>
                        </div>
                    </div>
                    <div class="bg-white flex items-center p-2 rounded-md cursor-pointer border-2 border-neutral-300">
                        <div class="flex items-center">
                            <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="-2 -2 24 24" preserveAspectRatio="xMinYMin"><path d="M4.376 8.068A5.944 5.944 0 0 0 4.056 10c0 .734.132 1.437.376 2.086a5.946 5.946 0 0 0 8.57 3.045h.001a5.96 5.96 0 0 0 2.564-3.043H10.22V8.132h9.605a10.019 10.019 0 0 1-.044 3.956 9.998 9.998 0 0 1-3.52 5.71A9.958 9.958 0 0 1 10 20 9.998 9.998 0 0 1 1.118 5.401 9.998 9.998 0 0 1 10 0c2.426 0 4.651.864 6.383 2.302l-3.24 2.652a5.948 5.948 0 0 0-8.767 3.114z"/>
                            </svg>
                            <p class="text-black ml-3 font-medium text-sm">Lier mon compte Google</p>
                        </div>
                    </div>
                </div>
            </div>
