...
export const members: Member[] = [
  ...
  },
  {
    tag: "saku",
    username: "Saku",
    description: "Je suis actuellement étudiant en tant que développeur web. Je me spécialise dans l'écosystème Javascript. J'utilise principalement React ainsi que Next.",
