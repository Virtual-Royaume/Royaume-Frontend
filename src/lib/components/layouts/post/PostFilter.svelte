...
<div>
    <div class="flex items-center justify-between border-b-2 pb-1 cursor-pointer" on:click={() => isOpen = !isOpen}>
        <h3 class="text-neutral-200 font-semibold text-xl">Filtres</h3>
        <svg class={`h-4 w-4 fill-neutral-200 transition-transform duration-300 ${isOpen ? '' : 'rotate-180'}`} xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 123.97 123.97" style="enable-background:new 0 0 123.97 123.97;" xml:space="preserve">
            <g>
