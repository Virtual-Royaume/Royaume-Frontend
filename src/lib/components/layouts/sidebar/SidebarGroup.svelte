...
<div class="border-b border-lightprimary mb-4 pb-4">
    <div on:click={toggle} class="flex justify-between items-center mb-2 cursor-pointer">
        <h3 class="uppercase tracking-widest text-neutral-200 font-semibold text-sm">{title}</h3>
        <svg class="fill-neutral-200 w-3 h-3 transition-transform duration-300" class:rotate-180={$settings.closedSidebarMenus?.includes(id)} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 30.727 30.727" style="enable-background:new 0 0 30.727 30.727;" xml:space="preserve">
            <g>
